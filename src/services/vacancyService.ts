...
export default class VacancyService{
    ...
    async create(url:string,vacancy:Partial<IVacancy>):Promise<IVacancy | {message:string}>{
        try{
            const response = await this.httpClient.post<IVacancy>("/api/vacancies", vacancy);
            return response;
        }catch(error){
